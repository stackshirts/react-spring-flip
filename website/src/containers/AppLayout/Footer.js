      ...
      <footer className="bd-footer text-muted">
        <div className="container-fluid p-3 p-md-5">
          <ul className="bd-footer-links">
            ...
            <li>
              <a href="{{ site.baseurl }}/{{ site.docs_version }}/examples/">Examples</a>
            </li>
            <li>
              <a href="{{ site.baseurl }}/{{ site.docs_version }}/about/overview/">About</a>
            </li>
          </ul>
          ...
          >@mdo</a> and <a
            ...
            target="_blank"
            rel="noopener"
          >@fat</a>. Maintained by the <a
            href="https://github.com/orgs/twbs/people"
          >core team</a> with the help of <a href="https://github.com/twbs/bootstrap/graphs/contributors">our
                                                                                                          contributors</a>.
          </p>
          <p>Currently v{{ site.current_version }}. Code licensed <a
